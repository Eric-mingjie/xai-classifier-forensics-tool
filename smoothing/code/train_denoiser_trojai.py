...
from architectures import DENOISERS_ARCHITECTURES, get_denoiser, IMAGENET_CLASSIFIERS
...
parser.add_argument('--n_channels', default=64, type=int)
...
def main():
    ...
    train_dataset = get_dataset(args.data, args.dataset, 'train')
    ...
    denoiser = get_denoiser(args.depth, args.n_channels)
    ...
    if args.objective == 'denoising':
        ...
        clf = torch.load(args.classifier)
        clf.cuda().eval()
